...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.VideoViewHolder> {
    ...
    public static boolean descViewVisible = false;
            ...
            profileImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onProfileImageClickListener != null) {
                        ...
                        else if(profileImageUrl.equals("https://firebasestorage.googleapis.com/v0/b/feastars-1861e.appspot.com/o/personalimages%2Fprofile_goldpapa.jpg?alt=media&token=c39cd13f-f9fb-4870-94c7-f3c71a5ee435")) {
                            onProfileImageClickListener.OnProfileImageClick("goldpapa");

                        }
                        else if(profileImageUrl.equals("https://firebasestorage.googleapis.com/v0/b/feastars-1861e.appspot.com/o/personalimages%2Fprofile_manwu.jpg?alt=media&token=d3d701b9-b993-4962-a0da-35ee79745153")) {
                            onProfileImageClickListener.OnProfileImageClick("manwu");
